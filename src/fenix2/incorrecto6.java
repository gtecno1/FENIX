 ...
 * @author GERALDO J
 */
public class incorrecto6 extends javax.swing.JFrame  implements Runnable {
Thread Hilo2;
  Thread Hilo1;
  int velocidad = 30;
  int y = 92;
     ...
     void i()
  {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seliccione un usuario");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(30, 20, 200, 22);
...
cerrar();// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(incorrecto6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
