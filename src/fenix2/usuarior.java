 ...
 * @author GERALDO J
 */
public class usuarior extends javax.swing.JFrame implements Runnable {
private int x=0; int y=92,velocidad=30;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cambie su usuario");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(40, 20, 170, 22);
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(usuarior.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
